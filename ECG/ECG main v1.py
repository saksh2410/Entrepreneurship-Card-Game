...
while win == 0:
    ...
    while endTurn == 0:
        ...
        choice = getChoice()               # Menu for user to choose their action(s)
        print("\n")
        ...
        if choice == 1:                                # Chooses to trigger skill cards
            ...
            print("\n")
        elif choice == 4:                               # Chooses to view his entire hand
            currentPlayer.printHold()
            print("\n")
        elif choice ==5:
            chanceCard(currentPlayer, chanceCards, chanceCardKeys) # Chooses to view chance cards
        elif choice == 9:
